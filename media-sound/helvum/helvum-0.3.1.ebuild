...
DESCRIPTION="Helvum is a GTK-based patchbay for pipewire"
HOMEPAGE="https://gitlab.freedesktop.org/ryuukyu/helvum"

SRC_URI="https://gitlab.freedesktop.org/ryuukyu/helvum/-/archive/0.3.1/helvum-0.3.1.tar.bz2 $(cargo_crate_uris ${CRATES})"
RESTRICT="mirror"
...
src_configure() {
	...
	meson_src_configure
	ln -sf ${CARGO_HOME}  ${BUILD_DIR}/cargo-home
}
#
src_compile() {
	meson_src_compile
