...
SRC_URI="amd64? ( http://download.brother.com/welcome/dlf105203/${MY_PN}-${PV}-${BUILD}.x86_64.rpm )
	x86? (	https://download.brother.com/welcome/dlf104035/brscan5-1.2.6-0.i386.rpm )
	http://download.brother.com/welcome/dlf105203/brother-udev-rule-type1-1.0.2-0.noarch.rpm"
